...
#ifndef __SRM_LOCALTANGENTSPACEAZIMUTHALSPHERICAL_H_INCLUDED__
#define __SRM_LOCALTANGENTSPACEAZIMUTHALSPHERICAL_H_INCLUDED__
...
/** This gets the Local Tangent Space Azimuthal Spherical SRF parameters.
    @param this_object in: this SRF object
    @param parameters out: resulting in the parameters of Local Tangent Space Azimuthal Spherical
...
/** This is the struct for the Local Tangent Space Azimuthal Spherical SRF.
...
/** This creates a new Local Tangent Space Azimuthal Spherical SRF.
    @param orm_code in: this object reference model
    @param rt_code in: this reference transformation
    @param parameters in: parameters for Local Tangent Space Azimuthal Spherical
