...
#ifndef __SRM_LOCOCENTRICEUCLIDEAN3D_H_INCLUDED__
#define __SRM_LOCOCENTRICEUCLIDEAN3D_H_INCLUDED__
...
/** This gets the Lococentric Euclidean 3D SRF parameters.
    @param this_object in: this SRF object
    @param parameters out: resulting in the parameters of Lococentric Euclidean 3D
...
/** This is the struct for the Lococentric Euclidean 3D SRF.
...
/** This creates a new Lococentric Euclidean 3D SRF.
    @param orm_code in: this object reference model
    @param rt_code in: this reference transformation
    @param parameters in: parameters for Lococentric Euclidean 3D
