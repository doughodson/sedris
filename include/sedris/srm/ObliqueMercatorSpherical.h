...
#ifndef __ObliqueMercatorSpherical_H__
#define __ObliqueMercatorSpherical_H__
 ...
 */
class SRF_ObliqueMercatorSpherical: public BaseSRF_MapProjection
{
public:
 ...
 */
class Coord3D_ObliqueMercatorSpherical: public Coord3D
{
public:
   /** Constructor
    */
...
/** A CoordSurf for SRF_ObliqueMercatorSpherical.
    ...
    @see SRF_ObliqueMercatorSpherical
 */
class CoordSurf_ObliqueMercatorSpherical: public CoordSurf
{
public:
   /** Constructor
    */
