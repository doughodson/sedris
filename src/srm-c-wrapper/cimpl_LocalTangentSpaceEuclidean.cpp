...
)
{
    ...
    else if (!INT_SRF( srf )->isA( BaseSRF::SRF_TYP_LTSE ))
    {
    ...
    else
    {
        ...
        {
            *parameters =
               ((SRF_LocalTangentSpaceEuclidean *)INT_SRF( srf ))->getSRFParameters();
        }
        catch( Exception e )
        {
            status = e.getCode();
...
)
{
    ...
    else if ((new_srf->methods = new SRM_LTSE_Method_List)==NULL)
    {
    ...
    new_srf->methods->GetSRFParameters                 = &cimpl_SRM_LTSE_GetSRFParameters;
    ...
    else
    {
        try
        {
            INT_SRF(srf) = SRF_LocalTangentSpaceEuclidean::create(orm_code,
                                                                  rt_code,
                                                                  *parameters);
