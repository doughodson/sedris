...
#ifndef __IMPL_PRIVATE_H__
#define __IMPL_PRIVATE_H__
...
extern std::vector <Impl_Path_Vector_Struct>*
...
std::vector <Impl_Op_Vector_Struct>* GenerateOpVector(std::vector <Impl_Path_Vector_Struct>* path_vector, SRM_Integer table_size);
...
typedef struct Impl_SRF
{
  ...
  */
    ...
    std::map<Impl_Map_Key, std::vector<CCSRFOp>*, Impl_Map_Key_Op>* op_cache;
