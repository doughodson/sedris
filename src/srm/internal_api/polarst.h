...
#ifndef __POLARST_H__
#define __POLARST_H__
 ...
 *    09-08-2010        SRM-specific updates. Eliminated
 *                      Get_Polar_Stereographic_Parameters() since it's
 *                      unused by SRM. Added comments indicating which
 *                      functions are invoked by what.
 */
 ...
 *
 * In the SRM, this function is invoked only by Convert_Geodetic_To_UPS()
 * and Convert_UPS_To_Geodetic() in ups.cpp
 */
 ...
 *
 * In the SRM, this function is invoked only by Convert_UPS_To_Geodetic()
 * in ups.cpp
 */
