...
)
{
        ...
        ((impl_srf=(Impl_SRF*)calloc(1,sizeof(Impl_SRF)))!=0))
    {
        ...
        */
        ...
        impl_srf->op_cache=new std::map<Impl_Map_Key, std::vector<CCSRFOp>*, Impl_Map_Key_Op>;
...
Impl_releaseSRF(void** api_srf_handle)
{
  ...
  */
    ...
    std::map<Impl_Map_Key, std::vector<CCSRFOp>*, Impl_Map_Key_Op>::iterator cleanup=to_free->op_cache->begin();
