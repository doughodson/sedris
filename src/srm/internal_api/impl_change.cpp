...
(
    ...
    std::vector <Impl_Op_Vector_Struct>* op_vector,
    std::vector <Impl_Path_Vector_Struct>* path_vector
)
{
    ...
    std::vector<Impl_Op_Vector_Struct>::iterator this_operation_iterator=op_vector->begin();
    std::vector<Impl_Op_Vector_Struct>::iterator next_operation_iterator=op_vector->begin();

    std::vector<CCSRFOp>* vm_program= new std::vector<CCSRFOp>;
           ...
           the same or that one or more of them is zero*/
    {
                     ...
                     (void*)&srf_tgt->map_key,sizeof(Impl_Map_Key)))
        {
            ...
            */
             ...
             */
            path_vector= new std::vector<Impl_Path_Vector_Struct>;
            op_vector= new std::vector <Impl_Op_Vector_Struct>;
...
)
{
  ...
  */
  ...
  SRM_Long_Float  input[4]={coord_src[0],coord_src[1],coord_src[2],1.0},
    ...
    std::vector<CCSRFOp>::iterator program_counter=program->begin();
...
)
{
    ...
    std::map<Impl_Map_Key, std::vector<CCSRFOp>*,Impl_Map_Key_Op>::iterator op_exists_iter;
