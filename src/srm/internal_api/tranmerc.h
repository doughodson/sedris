...
#ifndef __TRANMERC_H__
#define __TRANMERC_H__
 ...
 *
 * In the SRM, this function is invoked only by Convert_Geodetic_To_UTM()
 * and Convert_UTM_To_Geodetic() in utm.cpp
 */
 ...
 *
 * In the SRM, this function is invoked only by Convert_UTM_To_Geodetic()
 * in utm.cpp
 */
