 ...
 *    03-02-1997        Re-engineered Code
 *    08-05-2010        SRM edits - removed
 *                      Get_Transverse_Mercator_Parameters() function,
 *                      since it isn't used by the SRM.
 */

#include <math.h>     // Standard C math library
#include "tranmerc.h" // Is for prototype error checking
...
#define MAX_DELTA_LONG  (PI * 0.5)            /* 90 degrees in radians */
