...
std::vector <Impl_Path_Vector_Struct>*
...
{
   std::vector <Impl_Path_Vector_Struct>* path_vector1= new std::vector<Impl_Path_Vector_Struct> ;
...
#define TARGET 3
  ...
  /*A C debug to test for the possiblity of data corruption below*/
     ...
     */
    std::vector<Impl_Path_Vector_Struct>::reverse_iterator rpv=path_vector->rbegin();
    return path_vector1;
}
...
std::vector <Impl_Op_Vector_Struct>* GenerateOpVector
(
   std::vector <Impl_Path_Vector_Struct>* path_vector,
    SRM_Integer                       table_height
)
{
   std::vector <Impl_Op_Vector_Struct>* op_vector= new std::vector <Impl_Op_Vector_Struct> ;
   std::vector<Impl_Path_Vector_Struct>::reverse_iterator rpv=path_vector->rbegin();
   std::vector<Impl_Path_Vector_Struct>::reverse_iterator nrpv=path_vector->rbegin();
