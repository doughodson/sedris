...
#ifndef __SRM_SOLARMAGNETICDIPOLE_H_INCLUDED__
#define __SRM_SOLARMAGNETICDIPOLE_H_INCLUDED__
...
/** This is the struct for the Solar Magnetic Dipole SRF.
...
/** This creates a new Solar Magnetic Dipole SRF.
