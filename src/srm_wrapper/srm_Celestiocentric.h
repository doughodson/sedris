...
#ifndef __SRM_CELESTIOCENTRIC_H_INCLUDED__
#define __SRM_CELESTIOCENTRIC_H_INCLUDED__
...
/** This is the srm for Celestiocentric
...
/** This creates a new Celestiocentric SRF.
