...
int main()
{
   ...
   try {
      ...
      cd_srf = static_cast<srm::SRF_Celestiodetic*>(srm::BaseSRF::createStandardSRF(cd_srf_code, rt));
      cc_srf = static_cast<srm::SRF_Celestiocentric*>(srm::BaseSRF::createStandardSRF(cc_srf_code, rt));
